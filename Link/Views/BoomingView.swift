...
//        button.setTitleColor(.systemYellow, for: .normal)
    ...
    override init(frame: CGRect) {
        ...
        observer = NotificationCenter.default.addObserver(forName: .didTapPin, object: nil, queue: .main, using: { noti in
...
//        print("Booming people: \(self.locationString) and \(self.peopleJoining)")
    }
