...
//        linkTypeTextField.delegate = self
        ...
        let tap3 = UITapGestureRecognizer(target: self, action: #selector(didTapView))
...
//        backView.frame = CGRect(x: 10, y: 10, width: view.width-20, height: 60)
...
//        calenderImageView.frame = CGRect(x: linkTypeTextField.right, y: 20, width: 45, height: 35)
//        pickerView.frame = CGRect(x: linkTypeImage.right+10, y: 0, width: view.width-linkTypeImage.width-privacyButtonItem.width-50, height: 100)
        captionImage.frame = CGRect(x: 15, y: collectionView.bottom+20, width: 40, height: 40)
        captionTextField.frame = CGRect(x: captionImage.right+10, y: collectionView.bottom+20, width:  view.width-captionImage.width-50, height: 50)
//
//        peopleLabel.frame = CGRect(x: 15, y: captionTextField.bottom+20, width: view.width-30, height: 40)
//        peopleInvitedButton.frame = CGRect(x: 15, y: peopleLabel.bottom+20, width: 50, height: 50)
...
//        privacyButtonItem.frame = CGRect(x: locationTypeTextField.right+10, y: locationLabel.bottom+10, width: 45, height: 45)
